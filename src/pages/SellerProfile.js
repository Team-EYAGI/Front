      ...
      <Wrap>
        <Menu>
          ...
          <List>
            <ListBox>
              <h2>크리에이터</h2>
              <h3 onClick={() => {history.push(`/sellerProfile/{sellerName}/sellerAudio`)}}>업로드한 오디오북</h3>
              <h3 onClick={() => {history.push(`/sellerProfile/{sellerName}/sellerFunding`)}}>등록한 펀딩</h3>
            </ListBox>
          </List>
          <button id='submit'>크리에이터 신청하기</button>
        </Menu>
        <Body>
          {category === "sellerAudio" ?
          <MyPageAudioBook/>
          :
          category === "sellerFunding" ?
          <div>Funding</div>
          :
          <div>이게기본</div>
          }
